          ...
          <li>
            ...
            (
              ...
              <LineChartIcon className="h-5 w-5" />
                <span className={`text-sm font-medium ${isExpanded ? "block" : "hidden"}`}>Words and Analytics</span>
              </Link>
            )
            }
          </li>
...
function AssignIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
    	<path d="M487.19,99.922l-79.6-79.7c-38.2-38.2-83.4-12.9-96.3,0l-259.6,260c-1.9,1.9-3.2,4.2-3.8,6.8l-47.5,203.7
