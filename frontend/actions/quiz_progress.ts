...
export const upsertLearnCompleted = async (quizId: string, completed: boolean) => {
...
export const upsertQuestionCompleted = async (userQuestionId: string, completed: boolean) => {
    const session = await auth();
    const userId = session?.user?.id;
    console.log()
...
export const upsertQuizCompleted = async (userQuizId: string, completed: boolean) => {
    const session = await auth();
    const userId = session?.user?.id;
