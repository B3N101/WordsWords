  ...
  return (
    ...
    <div className="flex flex-col flex-1">
      ...
      <main className="flex justify-center flex-1">
        {!started ? <h1 className="text-3xl font-bol">Demo Words Quiz</h1>
        : (
          <div>
      ...
      <footer className="flow-root pb-9 px-6 bottom mb-0">
        ...
        <div className="float-right flex flex-col">
          ...
          <Button onClick={handleNext}>{!started ? 'Start' : (currentQuestion !== questions.length-1 ? 'Next' : 'Submit')} </Button>
        </div>
      </footer>
    </div>
    ):
